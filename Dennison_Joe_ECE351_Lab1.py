...
#%%Commenting
#This is a comment, and the following statement is not excuted:
#print(t+5)
...
plt.plot(x,y1) # choosing plot variable for x and y axes
...
plt.axis([-2.5, 2.5, -0.5, 4.5]) #difine axis
plt.grid(True)
...
.reshape #return the dimensions of an array (similar to numpy.reshape())
